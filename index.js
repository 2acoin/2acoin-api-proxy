...
function Self (opts) {
  ...
  this.bindIp = opts.bindIp || '108.61.205.5'
  ...
  this.dbFile = opts.dbFile || '2acoin'
  this.dbHost = opts.dbHost || '127.0.0.1'
  this.dbUser = opts.dbUser || '2acoin'
  this.dbPassword = opts.dbPassword || '2acoin'
  this.dbDatabase = opts.dbDatabase || '2acoin'
  ...
  */
  ...
  this.app.get('/supply', (request, response) => {
    this.getLastBlockHeader({
      host: this.defaultHost,
      port: this.defaultPort
    }).then((data) => {
